...
<div class="card-box form-center">
    <h2 style="margin-bottom: 1.5rem; text-align: center; font-weight: 800;">{{'Editar' if nota else 'Nova'}} Nota ⭐</h2>
    <form action="{{action}}" method="post">
        ...
        <input type="number" step="0.1" min="0" max="10" name="valor" class="form-input" required value="{{nota.valor if nota else ''}}">
        <div style="display: flex; gap: 1rem; margin-top: 1rem;">
            <a href="/notas" class="btn-block" style="background: #e2e8f0; color: var(--text-gray); text-decoration: none; box-shadow: none;">Cancelar</a>
