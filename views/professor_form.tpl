...
<div class="card-box form-center">
    <h2 style="margin-bottom: 1.5rem; text-align: center; font-weight: 800;">{{'Editar' if professor else 'Novo'}}
        Professor 📝</h2>
    <form action="{{action}}" method="post">
        ...
        <input type="text" name="materia" class="form-input" required
            value="{{professor.materia if professor else ''}}">
        ...
        <input type="text" name="contato" class="form-input" required
            value="{{professor.contato if professor else ''}}">
        <div style="display: flex; gap: 1rem; margin-top: 1rem;">
            <a href="/professores" class="btn-block"
