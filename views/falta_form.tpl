...
<div class="card-box form-center">
    <h2 style="margin-bottom: 1.5rem; text-align: center; font-weight: 800;">{{'Editar' if falta else 'Registrar'}}
        Falta 📅</h2>
    <form action="{{action}}" method="post">
        ...
        <input type="number" min="1" name="quantidade" class="form-input" required
            value="{{falta.quantidade if falta else ''}}">
        <div style="display: flex; gap: 1rem; margin-top: 1rem;">
            <a href="/faltas" class="btn-block"
